...
<div className='container'style={{height:"100vh", paddingTop:"50px",width:"100vw", margin:"0 auto"}}>
    ...
    <img src={`${process.env.PUBLIC_URL}/pictures/profilepicture.png`} alt="profile" style={{width:"250px", marginTop:"30px",marginLeft:"0"}}/>
     <div className='container'style={{paddingLeft:"33px"}}>
        ...
        <i className="bi bi-quote" style={{ fontSize:"30px"}}>Passionate to design web that feels right </i>
     </div>
